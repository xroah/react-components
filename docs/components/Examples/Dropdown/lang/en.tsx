...
export default {
    ...
    forceRenderApi: "If true will render once mounted, otherwise will render it when visible is true",
    offsetApi: "Offset of dropdown popup([horizontal, vertical])",
    delayApi: "A millisecond delay to show or hide the popup",
    onShowApi: "Callback is invoked when visible changes from false to true", 
    onShownApi: "Callback is invoked when popup has been shown",
    onHideApi: "Callback is invoked when visible change from true to false",
    onHiddenApi: "Callback is invoked when popup has been hidden",
