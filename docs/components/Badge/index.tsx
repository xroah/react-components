...
export default () => (
    <>
        <h2 className="doc-header">Badges</h2>
        <div>
            Badges scale to match the size of the immediate parent element by using relative font sizing and em units.
        </div>
        <div className="bd-example">
            <ScaleMatch/>
            <SyntaxHighlighter code={ScaleMathSrc}/>
        </div>
        <div>Badges can be used as part of links or buttons to provide a counter.</div>
        <div className="bd-example">
            <ButtonCounter/>
            <SyntaxHighlighter code={ButtonCounterSrc}/>
        </div>
        <div>
        ...
        <div className="bd-example">
            <Contextual/>
            <SyntaxHighlighter code={ContextualSrc}/>
        </div>
        <h2 className="doc-header">
            Pill badges
        </h2>
        ...
        <div>
            <Pill/>
            <SyntaxHighlighter code={PillSrc}/>
        </div>
        <h2>Links</h2>
        <div>
            <Pill/>
            <SyntaxHighlighter code={LinkSrc}/>
        </div>
    </>
);